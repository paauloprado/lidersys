...
import { RecoverPasswordForm } from '@/components/modules/auth/RecoverPasswordForm'

export const dynamic = 'force-dynamic'

export const metadata: Metadata = {
  title: 'Recuperar Senha | LiderSys',
  description: 'Recupere o acesso à sua conta na plataforma LiderSys.',
}
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 bg-brand-dark p-12 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-4xl lg:text-5xl font-black leading-tight mb-6 tracking-tight">
            Recupere o acesso à sua conta com total segurança.
          </h1>
          <p className="text-white/80 text-lg max-w-md leading-relaxed font-medium">
            Esqueceu sua senha? Sem problemas. Siga os passos e redefina suas credenciais em poucos instantes.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 relative">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 lg:text-left text-center">
            <h2 className="text-3xl font-black text-brand-dark tracking-tight mb-2">Recuperar senha</h2>
